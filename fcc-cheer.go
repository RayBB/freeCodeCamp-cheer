...
func getPoints(username string) UserInfo {

	//TODO: Add error handling for bad username

	var fccJSON map[string]interface{}
	getJSON("https://www.freecodecamp.org/api/users/get-public-profile?username="+username, &fccJSON)
	...
	return UserInfo{username, points}
}
